    ...
    return (
        <MaxWidthWrapper className="max-w-3xl mx-auto px-8 mb-40">
            <AnimationContainer delay={0.1} className="w-full">
                ...
                <p className="mt-8">
                    To use PinLens, you must be at least 18 years old and capable of entering into a binding contract.
                </p>
                ...
                <p className="mt-8 text-muted-foreground">
                    PinLens provides a URL shortening service that allows you to create shortened links from long URLs. You agree not to use this service to create links to illegal or harmful content.
                </p>
                ...
                <p className="mt-8 text-muted-foreground">
                    You are solely responsible for content you upload or create. PinLens does not endorse or assume any liability for user content.
                </p>
                ...
                <p className="mt-8 text-muted-foreground">
                    PinLens is provided on an &quot;as is&quot; and &quot;as available&quot; basis. We do not warrant that the service will be uninterrupted, error-free, or free from viruses or other harmful components.
                </p>
                ...
                <p className="mt-8 text-muted-foreground">
                    In no event shall PinLens be liable for any indirect, incidental, special, or consequential damages arising out of or in connection with your use of the service.
                </p>
                ...
                <p className="mt-8 text-muted-foreground">
                    If you have any questions or concerns about this Privacy Policy, please contact us at support@pinlens.io.
                </p>

                <p className="mt-8 font-medium">
                    By using PinLens, you acknowledge that you have read, understood, and agree to be bound by these terms and conditions.
                </p>
            </AnimationContainer>
        </MaxWidthWrapper>
    );
